...
public class Inventory {
    ...
    public void addItem(Items item, int quantity) {
        ...
        System.out.println("Inventory: Menambahkan " + quantity + "x " + itemName + ". Total sekarang: " + newQuantity); // Log
                                                                                                                         // untuk
                                                                                                                         // debug
        // TODO: Pertimbangkan untuk fire PropertyChangeEvent jika inventory perlu
        // diobservasi
        // support.firePropertyChange("inventoryUpdate", null, itemName);
    }
    ...
    public boolean removeItem(Items item, int quantity) {
        ...
        if (currentQuantity >= quantity) {
            ...
            // TODO: Pertimbangkan fire PropertyChangeEvent
            // support.firePropertyChange("inventoryUpdate", itemName, null);
            return true;
        } else {
            System.out.println(
